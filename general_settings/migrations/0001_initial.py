    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protocol', models.CharField(choices=[('https://', 'Live Site on: https://'), ('https://www.', 'Live Site with www: https://www'), ('http://', 'UAT Site:> http://')], default='https://', help_text='Warning! Make sure you have SSL Certificate for your site before switing to Secure options', max_length=20, verbose_name='Protocol Type')),
                ('is_parent_site', models.BooleanField(choices=[(True, 'Parent Site'), (False, 'Merchant Site')], default=True, verbose_name='Site Ownership')),
