...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='business_size',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='freelancers', to='general_settings.size', verbose_name='Business Size'),
        ),
        migrations.AddField(
            model_name='freelancer',
            name='department',
        ...
        migrations.AddField(
            model_name='freelancer',
            name='merchant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='freelancemerchant', to='account.merchant', verbose_name='Merchant'),
        ),
        migrations.AddField(
            model_name='freelancer',
            name='skill',
