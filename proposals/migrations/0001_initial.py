    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('progress', models.PositiveIntegerField(default=0, help_text='Proposal Progress', validators=[django.core.validators.MinValueValidator(10), django.core.validators.MaxValueValidator(100)], verbose_name='% Progress')),
