...
urlpatterns = [
    ...
    path('app<int:application_id>/<slug:project_slug>/',views.application_resolution, name='application_resolution'),

    path('proposal_start_work/',views.proposal_start_work, name='proposal_start_work'),
    path('id=<int:proposal_id>/<slug:proposal_slug>/',views.proposal_resolution, name='proposal_resolution'),
