...
urlpatterns = [
    ...
    path('<int:proposalsale_id>/<slug:proposal_slug>/',views.proposal_manager, name='proposal_resolution'),
    path('<int:application_id>/<slug:project_slug>/',views.application_manager, name='application_resolution'),
    path('<int:contractsale_id>/<slug:contract_slug>/',views.contract_manager, name='contract_resolution'),
